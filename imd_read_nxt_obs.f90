...
Integer,Dimension(130,1979:2016,1:12)::obs_mat_days
integer,Dimension(130,1979:2016,1:12,1:31,1:2)::fog_mat_int
integer::st_ind(130)
...
do i=1979,2016
  ...
  if(j.eq.2) then
     ...
     mon=j
      ...
      do k=1,31
         do l=2,2
write(3,'(i4,A1,i2.2,A1,i2.2,A1,i2.2,a1,130(i2))')i,"-",mon,"-",k,":",l," ",fog_mat_int(:,i,mon,k,l)
         end do
     end do
 end do 
end do
