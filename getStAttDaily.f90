...
real,Dimension(130,1979:2013,1:2,1:31)::maxT,minT,rf
integer,Dimension(130,1979:2013,1:2,1:31)::fog_ind,wind
CHARACTER(LEN=1),Dimension(130,1979:2013,1:2,1:31) :: wx1,wx2,wx3,wx4
CHARACTER(LEN=1),Dimension(130,1979:2013,1:2,1:31) :: wx1D,wx2D,wx3D,wx4D
real,Dimension(130,19):: attr
...
!write(3,'(i4,A1,i2.2,A1,i2.2,X,130(i2,X))')i,"-",mn,"-",k ,fog_ind(:,i,j,k)
